...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.70.3.6' );
...
if ( !function_exists( 'trx_addons_localize_scripts_front' ) ) {
	...
	function trx_addons_localize_scripts_front() {
		wp_localize_script( 'trx_addons', 'TRX_ADDONS_STORAGE', apply_filters('trx_addons_filter_localize_script', array(
			...
			'msg_magnific_prev'		    => addslashes(esc_html__('Previous (Left arrow key)', 'trx_addons')),
			'msg_magnific_next'		    => addslashes(esc_html__('Next (Right arrow key)', 'trx_addons')),
			'msg_magnific_counter'		=> addslashes(esc_html__('%curr% of %total%', 'trx_addons')),

...
?>>
	...
	<div class="sc_services_item_header <?php echo 1 == $args['hide_bg_image'] ? ' without_image' : ''; ?>"<?php if ((int)$args['hide_bg_image']==0 && !empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
